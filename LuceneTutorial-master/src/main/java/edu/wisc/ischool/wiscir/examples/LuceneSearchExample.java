...
public class LuceneSearchExample {
    ...
    public static void main( String[] args ) {
        try {
            ...
            String pathIndex = "C:\\Users\\onarg\\Desktop\\LuceneTutorial-master\\example_index_lucene";
            ...
            searcher.setSimilarity(new DFRSimilarity(new BasicModelG(), new AfterEffectB(), new NormalizationZ()));
