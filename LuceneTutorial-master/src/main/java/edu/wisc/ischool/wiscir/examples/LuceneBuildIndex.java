...
public class LuceneBuildIndex {
    ...
    public static void main( String[] args ) {
        try {
            ...
            String pathCorpus = "C:\\Users\\onarg\\Desktop\\LuceneTutorial-master\\example_corpus.gz";
            String pathIndex = "C:\\Users\\onarg\\Desktop\\example_index_lucene";
            ...
            config.setSimilarity(new DFRSimilarity(new BasicModelG(), new AfterEffectB(), new NormalizationZ()));
            
            
            //IBSimilarity similarity = new IBSimilarity(new DistributionLL(), new LambdaTTF(), 
            //		new NormalizationH3());
